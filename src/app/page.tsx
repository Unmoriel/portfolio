...
export default function Page() {
    ...
    return (
        ...
        <main
            className="flex flex-col space-y-10 min-h-screen bg-background font-sans antialiased max-w-2xl mx-auto py-12 sm:py-24 px-6">
            ...
            <section id="about">
                ...
                <BlurFade delay={BLUR_FADE_DELAY} className="flex justify-center items-center mt-5">
                        ...
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    ...
                                    J'ai travaillé sur plusieurs projets : scolaire, professionel ou personnel. Voici
                                    une compilation des plus intéressants.
