...
import {shape2pcsData} from "@/data/shape2pcs";
import { Carousel } from "@/components/carousel";
import {Icons} from "@/components/icons";

const BLUR_FADE_DELAY = 0.1;

const project = shape2pcsData;

export default function Shape2PCS({}) {
                    ...
                    <div className="lg:pr-4">
                        <div className="lg:max-w-lg">
                            ...
                            <BlurFade delay={BLUR_FADE_DELAY * 3}>
                                <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Contexte
                                    du projet</h2>
                            </BlurFade>
